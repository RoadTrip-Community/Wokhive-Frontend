    ...
    <div>
      <div className='border-b border-[#eee]'>
        <h2 className='py-4 text-Display-xs font-bold font-romela w-11/12 max-w-[1024px] mx-auto'>
          Privacy Policy for Wokhive
        </h2>
      </div>
      <div className='relative w-11/12 max-w-[1024px] mx-auto'>
        <h1 className='font-bold font-romela text-[40px] leading-[60px] my-7'>Privacy Policy</h1>
        ...
        <h2 className='font-bold font-romela text-[32px] leading-[48px] my-6'>Interpretation and Definitions</h2>
        <h3 className='font-bold font-romela text-Display-xs my-6'>Interpretation</h3>
        <p className='my-4 text-Text-md'>
          The words of which the initial letter is capitalized have meanings defined under the following conditions. The
          following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
        </p>
        <h3 className='font-bold font-romela text-Display-xs my-6'>Definitions</h3>
        <p className='my-4 text-Text-md'>For the purposes of this Privacy Policy:</p>
        <ul className='list-disc my-4 pl-10'>
          ...
          <li>
            <p className='my-4 text-Text-md'>
              ...
              &quot;Our&quot; in this Agreement) refers to wokhive, Lagos..
            </p>
          </li>
          <li>
            <p className='my-4 text-Text-md'>
          ...
          <li>
            <p className='my-4 text-Text-md'>
              <strong>Website</strong> refers to wokhive, accessible from{' '}
              <Link
                className='text-primary-purple-50 hover:text-primary-milk-60 transition-all'
                href='https://wokhive.com'
                rel='noopener'
                target='_blank'
              >
                https://wokhive.com
        ...
        <h2 className='font-bold font-romela text-Display-xs my-6'>Collecting and Using Your Personal Data</h2>
        <h3 className='font-bold font-romela text-Display-xs my-6'>Types of Data Collected</h3>
        <h4 className='font-bold font-romela text-Text-xl my-6'>Personal Data</h4>
        <p className='my-4 text-Text-md'>
        ...
        <ul className='list-disc my-4 pl-10'>
          <li>
            <p className='my-4 text-Text-md'>Email address</p>
          </li>
          <li>
            <p className='my-4 text-Text-md'>First name and last name</p>
          </li>
          <li>
            <p className='my-4 text-Text-md'>Phone number</p>
          </li>
          <li>
            <p className='my-4 text-Text-md'>Address, State, Province, ZIP/Postal code, City</p>
          </li>
          <li>
            <p className='my-4 text-Text-md'>Usage Data</p>
          </li>
        </ul>
        <h4 className='font-bold font-romela text-Text-xl my-6'>Usage Data</h4>
        <p className='my-4 text-Text-md'>Usage Data is collected automatically when using the Service.</p>
        <p className='my-4 text-Text-md'>
        ...
        <h4 className='font-bold font-romela text-Text-xl my-6'>Information from Third-Party Social Media Services</h4>
        <p className='my-4 text-Text-md'>
        ...
        <h4 className='font-bold font-romela text-Text-xl my-6'>Tracking Technologies and Cookies</h4>
        <p className='my-4 text-Text-md'>
        ...
        <p className='my-4 text-Text-md'>We use both Session and Persistent Cookies for the purposes set out below:</p>
        <ul className='list-disc my-4 pl-10'>
          <li>
            <p className='my-4 text-Text-md'>
              <strong>Necessary / Essential Cookies</strong>
            </p>
            <p className='my-4 text-Text-md'>Type: Session Cookies</p>
            <p className='my-4 text-Text-md'>Administered by: Us</p>
            <p className='my-4 text-Text-md'>
          ...
          <li>
            ...
            <p className='my-4 text-Text-md'>Type: Persistent Cookies</p>
            <p className='my-4 text-Text-md'>Administered by: Us</p>
            <p className='my-4 text-Text-md'>
        ...
        <h3 className='font-bold font-romela text-Display-xs my-6'>Use of Your Personal Data</h3>
        <p className='my-4 text-Text-md'>The Company may use Personal Data for the following purposes:</p>
        <ul className='list-disc my-4 pl-10'>
          <li>
            <p className='my-4 text-Text-md'>
        ...
        <p className='my-4 text-Text-md'>We may share Your personal information in the following situations:</p>
        <ul className='list-disc my-4 pl-10'>
          <li>
        ...
        <h3 className='font-bold font-romela text-Display-xs my-6'>Retention of Your Personal Data</h3>
        <p className='my-4 text-Text-md'>
        ...
        <h3 className='font-bold font-romela text-Display-xs my-6'>Transfer of Your Personal Data</h3>
        <p className='my-4 text-Text-md'>
        ...
        <h3 className='font-bold font-romela text-Display-xs my-6'>Delete Your Personal Data</h3>
        <p className='my-4 text-Text-md'>
        ...
        <h3 className='font-bold font-romela text-Display-xs my-6'>Disclosure of Your Personal Data</h3>
        <h4 className='font-bold font-romela text-Text-xl my-6'>Business Transactions</h4>
        <p className='my-4 text-Text-md'>
        ...
        <h4 className='font-bold font-romela text-Text-xl my-6'>Law enforcement</h4>
        <p className='my-4 text-Text-md'>
        ...
        <h4 className='font-bold font-romela text-Text-xl my-6'>Other legal requirements</h4>
        <p className='my-4 text-Text-md'>
        ...
        <h3 className='font-bold font-romela text-Display-xs my-6'>Security of Your Personal Data</h3>
        <p className='my-4 text-Text-md'>
        ...
        <h2 className='font-bold font-romela text-Display-xs my-6'>{"Children's"} Privacy</h2>
        <p className='my-4 text-Text-md'>
        ...
        <h2 className='font-bold font-romela text-Display-xs my-6'>Links to Other Websites</h2>
        <p className='my-4 text-Text-md'>
        ...
        <h2 className='font-bold font-romela text-Display-xs my-6'>Changes to this Privacy Policy</h2>
        <p className='my-4 text-Text-md'>
        ...
        <h2 className='font-bold font-romela text-Display-xs my-6'>Contact Us</h2>
        <p className='my-4 text-Text-md'>If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul className='list-disc my-4 pl-10'>
          <li>
            By email:{' '}
            <Link

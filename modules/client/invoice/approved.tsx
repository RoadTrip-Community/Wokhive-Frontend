...
const ApprovedInvoice = ({ invoices }: ApprovedInvoiceProps) => {
    ...
    <div>
      {invoices.length > 0 ? (
        ...
        <div className='flex flex-col justify-center items-center my-72 gap-4'>
          ...
          <h1 className='text-gray-900 text-Text-lg font-semibold'>No approved invoices yet</h1>

          <p className='text-center text-gray-900 opacity-70'>
            Once invoices are approved, they will appear here. Keep up the great work!
          </p>
        </div>
      )}

...
const InactiveInvoice = ({ invoices }: ApprovedInvoiceProps) => {
    ...
    <div>
      {invoices.length > 0 ? (
        ...
        <div className='flex flex-col justify-center items-center my-72 gap-4'>
          ...
          <h1 className='text-gray-900 text-Text-lg font-semibold'>No Inactive Invoices Found</h1>

          <p className='text-center text-gray-900 opacity-70'>
            Looks like you&apos;re all caught up! There are currently no inactive invoices to display. Get back to
            managing your active invoices or take a moment to celebrate your efficiency. If you need any assistance, our
